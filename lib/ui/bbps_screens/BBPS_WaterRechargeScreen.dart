...
class BBPSWaterRechargeScreen extends StatefulWidget {
  @override
  _BBPSWaterRechargeScreenState createState() =>
      _BBPSWaterRechargeScreenState();
}

class _BBPSWaterRechargeScreenState extends State<BBPSWaterRechargeScreen> {
  String? jwt_token = "";
  String? authToken = "";
  ...
  void fetchWaterBillers() {
    HTTPService().fetchBBPSBillers(authToken!, '13').then((response) {
      if (response.statusCode == 200) {
