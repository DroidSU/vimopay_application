...
class BBPSPostpaidRechargeScreen extends StatefulWidget {
  @override
  _BBPSPostpaidRechargeScreenState createState() =>
      _BBPSPostpaidRechargeScreenState();
}

class _BBPSPostpaidRechargeScreenState
    extends State<BBPSPostpaidRechargeScreen> {
  String? jwt_token = "";
  String? authToken = "";
  ...
  void fetchPostpaidBillers() {
    HTTPService().fetchBBPSBillers(authToken!, '12').then((response) {
      if (response.statusCode == 200) {
