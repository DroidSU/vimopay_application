...
class BBPSGasRechargeScreen extends StatefulWidget {
  @override
  _BBPSGasRechargeScreenState createState() => _BBPSGasRechargeScreenState();
}

class _BBPSGasRechargeScreenState extends State<BBPSGasRechargeScreen> {
  String? jwt_token = "";
  String? authToken = "";
  ...
  void fetchGasBillers() {
    HTTPService().fetchBBPSBillers(authToken!, '6').then((response) {
      if (response.statusCode == 200) {
