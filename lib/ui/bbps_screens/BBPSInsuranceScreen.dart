...
class BBPSInsuranceScreen extends StatefulWidget {
  @override
  _BBPSInsuranceScreenState createState() => _BBPSInsuranceScreenState();
}

class _BBPSInsuranceScreenState extends State<BBPSInsuranceScreen> {
  String? jwt_token = "";
  String? authToken = "";
  ...
  void fetchInsuranceBillers() {
    HTTPService().fetchBBPSBillers(authToken!, '9').then((response) {
      if (response.statusCode == 200) {
